      ...
      <section className="relative py-24 flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="px-8 py-4 bg-brand-blue text-white font-semibold rounded-md hover:bg-brand-blue-light transition-colors shadow-[0_0_20px_rgba(0,85,255,0.4)] text-lg cursor-pointer">
              Explore Our Work
            </button>
            <button className="px-8 py-4 border border-brand-gold text-brand-gold font-semibold rounded-md hover:bg-brand-gold hover:text-dark-bg transition-colors shadow-[0_0_15px_rgba(255,183,0,0.2)] text-lg cursor-pointer">
      ...
      <section className="py-20 bg-dark-surface border-y border-dark-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Construction */}
            <div className="bg-dark-bg border border-dark-border rounded-xl p-8 hover:border-brand-blue transition-colors group cursor-pointer">
            ...
            {/* Sales */}
            <div className="bg-dark-bg border border-dark-border rounded-xl p-8 hover:border-brand-gold transition-colors group cursor-pointer">
